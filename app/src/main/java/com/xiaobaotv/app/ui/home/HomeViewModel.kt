    ...
    fun loadHomeContent() {
        viewModelScope.launch {
            ...
            try {
                ...
                val moviesResult = getVodListUseCase(typeId = 1, limit = 10)
                val tvResult = getVodListUseCase(typeId = 2, limit = 10)
                val animeResult = getVodListUseCase(typeId = 4, limit = 10)
